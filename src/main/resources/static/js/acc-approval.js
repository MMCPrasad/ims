function approvalInitiate(target, pageName, tableData, formData) {
    this.dataTable = null;
    const selector =
                    ...
                    fetch("accApproval/" + action , {
                        ...
                        headers: headers,
                            ...
                            .then((data) => {
                                ...
                                Swal.fire("Successful!", data.message, "success").then(() => {
                                    location.reload();
                                });
                            })
                            .catch((error) => {
                                Swal.fire("Error!", "Failed to update record: " + error.message, "error");
                            });
                }
            });
        }
